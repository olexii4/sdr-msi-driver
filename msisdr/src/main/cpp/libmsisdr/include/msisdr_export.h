...
#ifndef __MSISDR_EXPORT_H
#define __MSISDR_EXPORT_H
...
#ifndef msisdr_STATIC
#  ifdef msisdr_EXPORTS
#    define MSISDR_API __SDR_EXPORT
#  else
#    define MSISDR_API __SDR_IMPORT
#  endif
#else
#  define MSISDR_API
#endif
#endif /* __MSISDR_EXPORT_H */
